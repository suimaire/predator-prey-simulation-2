...
import { DEFAULT_PARAMETERS, ForestSimulation, SPECIES_LABELS, activeSpecies, validateParameters } from '../src/model.ts';
...
function setup() {
  ...
  const context = vm.createContext({
    DEFAULT_PARAMETERS, APEX_CHALLENGE_CONFIG, BOARD_TAB_MARKUP, BOARD_GROUPS: [],
